...
| MENA impact | The three journeys cover remittance, wallet cash-out, and account-takeover risk without requiring a bank to expose payment credentials to the telecom layer. |
...
| Technical feasibility | The demo calls Nokia Network as Code for SIM Swap, Device Reachability, Location Verification, and Roaming Status, with visible evidence and explicit timeout behavior. |
| Agentic orchestration | The planner selects and explains multiple API calls; mandatory checks and deterministic policy bounds prevent an AI-generated plan from weakening safety. |
...
- The AI planner cannot omit the mandatory SIM Swap and Device Reachability checks.
