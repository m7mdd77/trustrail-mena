...
export const scenarios: DemoScenario[] = [
  {
    ...
    transaction: {
      ...
      consentReference: "consent_wallet-registration_fatima",
    },
  ...
  },
  {
    ...
    transaction: {
      ...
      contextNote: "The customer reports travelling abroad; the transfer note says “family emergency”; a new device session appeared six hours ago.",
      consentReference: "consent_wallet-registration_aisha",
    },
  ...
  },
  {
    ...
    transaction: {
      ...
      consentReference: "consent_wallet-registration_yousef",
    },
